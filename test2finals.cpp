...
void displayMenu() {
    ...
    std::cout << COLOR_YELLOW << "║ " << COLOR_BOLD << "9." << COLOR_RESET << COLOR_YELLOW << " Exit\n" << COLOR_RESET;
    std::cout << COLOR_CYAN << "║\n╚═══════════════════════════════════════════════════════════╝\n" << COLOR_RESET;
    std::cout << COLOR_MAGENTA << COLOR_BOLD << "Enter your choice (1-9): " << COLOR_RESET;
}
...
int main() {
    ...
    // If no students were loaded, use default data
    if (allStudents.empty()) {
